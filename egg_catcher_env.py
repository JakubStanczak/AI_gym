...
class Egg_Catcher:
	def __init__(self, env_size=(30, 30, 3), render=True, max_moves=500, drop_every=5):
		self.size = env_size
	...
	def draw(self):
		show_env = cv2.resize(self.env, (self.size[0] * 10, self.size[1] * 10), interpolation=cv2.INTER_AREA)
